...
<table>
	...
	<tr><td>Cons. Jour</td><td><input type="text" name="cons_jour_b" maxlength="4" size="4" value="<?=$data['CONS_JOUR_B']->value?>"> °C</td></tr>
	<tr><td>Cons. Nuit</td><td><input type="text" name="cons_nuit_b" maxlength="4" size="4" value="<?=$data['CONS_NUIT_B']->value?>"> °C</td></tr>
	<tr><td>Cons. Antigel</td><td><input type="text" name="cons_antigel_b" maxlength="4" size="4" value="<?=$data['CONS_ANTIGEL_B']->value?>"> °C</td></tr>
...
<p><a href="index.php?view=page1&circuit=B">Panneau de Contrôle</a></p>
</body>
</html>
