...
<table>
	...
	<tr><td>Cons. Jour</td><td><input type="text" name="cons_jour_a" maxlength="4" size="4" value="<?=$data->reg['CONS_JOUR_A']->value?>"> °C</td></tr>
	<tr><td>Cons. Nuit</td><td><input type="text" name="cons_nuit_a" maxlength="4" size="4" value="<?=$data->reg['CONS_NUIT_A']->value?>"> °C</td></tr>
	<tr><td>Cons. Antigel</td><td><input type="text" name="cons_antigel_a" maxlength="4" size="4" value="<?=$data->reg['CONS_ANTIGEL_A']->value?>"> °C</td></tr>
...
<p><a href="index.php?view=page1&circuit=A">Panneau de Contrôle</a> <a href="index.php?view=param">Paramètres</a></p>
</body>
</html>
