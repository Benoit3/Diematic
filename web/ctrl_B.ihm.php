...
<table>
	...
	<tr><td>Temp Chaud Mesure/Cible</td><td><?=$data['TEMP_CHAUD']->value?> °C / <?=$data['TCALC_B']->value?> °C</td></tr>
	...
	<tr><td>Mode Chauffage</td><td>
			<select name="mode_chauffage">
				...
				<option value="8"  <?= ((($data['MODE_B']->value&0x2F)==8) ? "SELECTED" : "")  ?> >AUTO</option>
				<option value="36" <?= ((($data['MODE_B']->value&0x2F)==36) ? "SELECTED" : "") ?> >DEROG JOUR</option>
				<option value="34" <?= ((($data['MODE_B']->value&0x2F)==34) ? "SELECTED" : "") ?> >DEROG NUIT</option>
				<option value="4"  <?= ((($data['MODE_B']->value&0x2F)==4) ? "SELECTED" : "") ?> >PERM JOUR</option>
				<option value="2"  <?= ((($data['MODE_B']->value&0x2F)==2) ? "SELECTED" : "") ?> >PERM NUIT</option>
	...
	<tr><td>Mode ECS</td><td>
			<select name="mode_ecs">
				<option value="0"  <?= ((($data['MODE_B']->value&0x50)==0) ? "SELECTED" : "")  ?> >AUTO</option>
				<option value="80" <?= ((($data['MODE_B']->value&0x50)==0x50) ? "SELECTED" : "") ?> >TEMP</option>
				<option value="16" <?= ((($data['MODE_B']->value&0x50)==0x10) ? "SELECTED" : "") ?> >PERM</option>
			</select>
	</td></tr>
